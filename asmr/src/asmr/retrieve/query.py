...
class QueryContent:
    ...
    def __init__(self, content: Union[str, Image.Image], data_type: Optional[str] = None):
...
class Query:
    ...
    def __post_init__(self):
        if self.text is None and self.image is None:
            raise ValueError("Query must have at least one content type (text or image)")
    ...
    def get_target_fields(self, field_configs: Dict[str, 'FieldConfig']) -> List['FieldConfig']:
    ...
    @classmethod
    def from_image(cls, image: Union[str, Image.Image], data_type: str = 'image') -> 'Query':
    ...
    @classmethod
    def from_multimodal(cls, text: str, image: Union[str, Image.Image], 
                       text_data_type: str = 'text', image_data_type: str = 'image') -> 'Query':
